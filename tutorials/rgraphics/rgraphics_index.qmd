...
<p align="right">
  ...
  <a href="https://girke.bioinformatics.ucr.edu/GEN242/slides/rgraphics/rgraphics_page.html" target="_blank" rel="noopener noreferrer" style="text-decoration:none">
...
The following imports a `mortgage` payment function (from [here](https://raw.githubusercontent.com/tgirke/GEN242/refs/heads/main/tutorials/rgraphics/scripts/mortgage.R)) that calculates
...
```{r bar_plot_mortgage}
source("https://raw.githubusercontent.com/tgirke/GEN242/refs/heads/main/tutorials/rgraphics/scripts/mortgage.R")
...
<ol reversed>
    <li>Theme: styles to be used, such as fonts, backgrounds, etc.</li>
    <li>Coordinates: the plotting space</li>
    <li>Statistics: data models and summaries</li>
    <li>Facets: row and column layout of sub-plots</li>
    <li>Geometries: shapes used to represent data (_e.g._ bar or scatter plot)</li>
    <li>Aesthetics: the scales onto which the data will be mapped</li>
    <li>Data: the actual data to be plotted</li>
</ol>

![sphm](images/grammar_ggplot2.png){fig-align="center"}
...
Standard R export functons for graphics work as well (see [here](https://girke.bioinformatics.ucr.edu/GEN242/tutorials/rgraphics/rgraphics_index.html#saving-graphics-to-files)). 
...
![sphm](images/spatial_heatmap.jpeg){fig-align="center"}
...
![vim-r](images/circularplot.png){fig-align="center"}
...
![vim-r](images/igv_peak_3.png){fig-align="center"}
