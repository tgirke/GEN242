...
::: {.callout-note}
## [Posit Assistant in RStudio](https://posit.co/products/ai): A Note for R Users (applies to situation in June 2026)
...
Assistant uses Posit AI as its managed backend (currently $20/month),
...
does not cover Claude Code. They are entirely independent services. If your
primary need is script writing on a cluster, a Claude Code subscription used
via the RStudio terminal (see below) is likely the more cost-effective and 
practical path, at least as of now.
:::
