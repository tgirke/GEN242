...
To minimize typing, it can be helful to start with an Quarto template and
then modify it as needed. Note the file name of an Quarto scirpt needs to
have the extension `.qmd`. Template files for the following examples are available 
here:
