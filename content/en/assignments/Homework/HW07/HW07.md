...
> **_EXCEPTION:_**
  ...
  RStudio session to this directory. Next open the provided `HW07.Rmd` file under `HW7_data/rnaseq` and follow the instructions given in this file, that contains quite a bit of additional helper code. 
